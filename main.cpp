...
int main()
{
	...
	cout << "Please enter a men's name" << endl;
	getline(cin, mansName);

	cout << "There once a " << adjective1 << " girl name " << girlName << " who was a " << adjective2 << 
		" " << occupation1 << " in the Kingdom of " << placeName << ". She loved to wear " << clothing << " and " << hobby << ". She wanted to marry the "
